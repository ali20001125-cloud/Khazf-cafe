    ...
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      <section className="card space-y-5 p-5">
        ...
        <Field
          ...
          hint="لو تُرك الجهاز بلا لمسٍ هذه المدّة، تُنهى الجلسة وتُقفل الشاشة — في الكاشير وفي لوحة الإدارة معاً. والقفل حقيقيّ لا ستارة: التحديث يرمي إلى شاشة الدخول. الطلب المفتوح يبقى في الشاشة ويعود بعد إدخال الرمز. صفر = لا قفل."
        >
          <input
            type="number"
            inputMode="numeric"
